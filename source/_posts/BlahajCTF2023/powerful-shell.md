...
{% ccb lang:powershell wrapped:true scrollable:true %}
...
This has two parts, a streamreader that decompresses the base64 string, and then pipes the result into the `( $eNV:COmSpEC[4,26,25]-join'')`. The `( $eNV:COmSpEC[4,26,25]-join'')` runs `iex`, which according to google:

> “Invoke expressions” (IEX) in PowerShell are a common method of executing code.

To see what sort os code is being run, we remove the ` | & ( $eNV:COmSpEC[4,26,25]-join'')` part and paste it into powershell like this:
```powershell
PS C:\Users\ryan> ( new-OBJECT SYStem.iO.sTReamReAdER(( new-OBJECT  SyStem.Io.ComPrEsSION.deFLaTESTReam([SyStEM.iO.meMoRystreAM][sySTeM.CONVERt]::FrombaSE64STRIng( '') , [sysTEM.IO.COMprESSION.coMPrESsioNmODe]::DecOMPrEss ) ), [sYstem.TexT.ENCoDiNg]::aScII)).rEaDTOend()
```
and we get this output:

{% ccb lang:powershell scrollable:true %}
